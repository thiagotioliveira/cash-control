...
public class RevertTransfer {

  private final EventStore eventStore;
  private final EventPublisher publisher;

  public RevertTransfer(EventStore eventStore, EventPublisher publisher) {
    this.eventStore = eventStore;
    this.publisher = publisher;
  }

  public void execute(RevertTransferCommand command) {
    ...
    transfer.revert(command.userId());
