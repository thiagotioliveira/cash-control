...
public class TransactionController {
  ...
  @GetMapping("/{accountId}/transactions/{yearMonth:\\d{4}-\\d{2}}")
  ...
  @GetMapping("/{accountId}/transactions/review")
  ...
  public String postTransaction(
    ...
    try {
      ...
      return String.format("redirect:/protected/accounts/%s/transactions/review", accountId);
    }
  }
  ...
  @PostMapping("/{accountId}/transactions/{transactionId}/delete")
  public String deleteTransaction(
    ...
    try {
      ...
      return String.format(
          "redirect:/protected/accounts/%s/transactions/%s", accountId, transactionId);
    }
  }

  @PostMapping("/{accountId}/transactions/{transactionId}")
  public String postTransaction(
      @PathVariable UUID accountId,
      @PathVariable UUID transactionId,
      @ModelAttribute TransactionActionSheetModel.TransactionForm form,
